...
<div style="overscroll-behavior: none;">
    <div
      class="fixed flex justify-between w-full h-16 pt-2 text-white bg-green-400 shadow-md"
    ...
    <div class="mt-20 mb-16">
        @foreach ($messages as $chat)
            ...
            <div class="clearfix w-4/4">
                <div
                class="inline-block p-2 mx-4 my-2 bg-gray-300 rounded-lg"
                >
            ...
            <div class="clearfix w-4/4">
                <div class="text-right">
                    <p class="inline-block p-2 mx-4 my-2 bg-green-300 rounded-lg">
                        {{$chat['message']}} <b>: You</b>
                    </p>
                </div>
            </div>
            @endif
